...
ThankYouPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ThankYouPage, selectors: [["ng-component"]], decls: 62, vars: 15, consts: [["mat-card-image", "", "src", "https://kwik-e-mart.s3.eu-central-1.amazonaws.com/assets/thank-you-come-again.jpg"], [3, "dataSource"], ["scope", "row"], ["mat-button", "", "download", "", 3, "href"], ["mat-button", "", "color", "primary", "routerLink", "/customer"]], template: function ThankYouPage_Template(rf, ctx) { if (rf & 1) {
...
WelcomePage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: WelcomePage, selectors: [["kwik-e-mart-welcome"]], decls: 17, vars: 11, consts: [[1, "grid-list"], ["id", "welcome-image", 1, "grid-tile"], ["src", "https://kwik-e-mart.s3.eu-central-1.amazonaws.com/assets/kwik-e-mart.png"], ["id", "welcome-auth", 1, "grid-tile"], ["id", "welcome-stats", 1, "grid-tile"], [4, "ngIf"]], template: function WelcomePage_Template(rf, ctx) { if (rf & 1) {
